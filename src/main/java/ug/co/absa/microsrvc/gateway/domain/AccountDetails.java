...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "accountdetails")
...
public class AccountDetails implements Serializable {
    ...
    public AccountDetails absaTranRef(UUID absaTranRef) {
    ...
    public AccountDetails billerId(String billerId) {
    ...
    public AccountDetails paymentItemCode(String paymentItemCode) {
    ...
    public AccountDetails dtDTransactionId(String dtDTransactionId) {
    ...
    public AccountDetails amolDTransactionId(String amolDTransactionId) {
    ...
    public AccountDetails transactionReferenceNumber(String transactionReferenceNumber) {
    ...
    public AccountDetails token(String token) {
        this.setToken(token);
        return this;
    }
    ...
    public AccountDetails transferId(String transferId) {
    ...
    public AccountDetails requestId(Integer requestId) {
    ...
    public AccountDetails returnCode(String returnCode) {
    ...
    public AccountDetails returnMessage(String returnMessage) {
    ...
    public AccountDetails externalTXNid(String externalTXNid) {
    ...
    public AccountDetails transactionDate(ZonedDateTime transactionDate) {
    ...
    public AccountDetails customerId(String customerId) {
    ...
    public AccountDetails customerProduct(String customerProduct) {
    ...
    public AccountDetails customerType(String customerType) {
    ...
    public AccountDetails accountCategory(String accountCategory) {
    ...
    public AccountDetails channel(String channel) {
    ...
    public AccountDetails tranFreeField1(String tranFreeField1) {
    ...
    public AccountDetails tranFreeField2(String tranFreeField2) {
    ...
    public AccountDetails tranFreeField3(String tranFreeField3) {
    ...
    public AccountDetails tranFreeField4(String tranFreeField4) {
    ...
    public AccountDetails tranFreeField5(String tranFreeField5) {
    ...
    public AccountDetails tranFreeField6(String tranFreeField6) {
    ...
    public AccountDetails tranFreeField7(String tranFreeField7) {
    ...
    public AccountDetails tranFreeField8(String tranFreeField8) {
    ...
    public AccountDetails tranFreeField9(String tranFreeField9) {
    ...
    public AccountDetails tranFreeField10(String tranFreeField10) {
    ...
    public AccountDetails tranFreeField11(String tranFreeField11) {
    ...
    public AccountDetails tranFreeField12(String tranFreeField12) {
    ...
    public AccountDetails tranFreeField13(String tranFreeField13) {
    ...
    public AccountDetails tranFreeField14(String tranFreeField14) {
    ...
    public AccountDetails tranFreeField15(String tranFreeField15) {
    ...
    public AccountDetails tranFreeField16(String tranFreeField16) {
    ...
    public AccountDetails tranFreeField17(String tranFreeField17) {
    ...
    public AccountDetails tranFreeField18(BigDecimal tranFreeField18) {
    ...
    public AccountDetails tranFreeField19(Integer tranFreeField19) {
    ...
    public AccountDetails tranFreeField20(Boolean tranFreeField20) {
    ...
    public AccountDetails tranFreeField21(String tranFreeField21) {
    ...
    public AccountDetails tranFreeField22(String tranFreeField22) {
    ...
    public AccountDetails tranFreeField23(byte[] tranFreeField23) {
    ...
    public AccountDetails tranFreeField23ContentType(String tranFreeField23ContentType) {
    ...
    public AccountDetails tranFreeField24(ZonedDateTime tranFreeField24) {
    ...
    public AccountDetails tranFreeField25(String tranFreeField25) {
    ...
    public AccountDetails tranFreeField26(String tranFreeField26) {
    ...
    public AccountDetails tranFreeField27(String tranFreeField27) {
    ...
    public AccountDetails tranFreeField28(String tranFreeField28) {
    ...
    public AccountDetails tranFreeField29(String tranFreeField29) {
    ...
    public AccountDetails tranFreeField30(String tranFreeField30) {
    ...
    public AccountDetails tranFreeField31(String tranFreeField31) {
    ...
    public AccountDetails tranFreeField32(String tranFreeField32) {
    ...
    public AccountDetails tranFreeField33(String tranFreeField33) {
    ...
    public AccountDetails createdAt(ZonedDateTime createdAt) {
    ...
    public AccountDetails createdBy(String createdBy) {
    ...
    public AccountDetails updatedAt(ZonedDateTime updatedAt) {
    ...
    public AccountDetails updatedBy(String updatedBy) {
