...
import ug.co.absa.microsrvc.gateway.repository.search.RegionSearchRepository;
import ug.co.absa.microsrvc.gateway.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link ug.co.absa.microsrvc.gateway.domain.Region}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RegionResource {
    ...
    public Mono<List<Region>> searchRegions(@RequestParam String query) {
        ...
        return regionSearchRepository.search(query).collectList();
    }
}
