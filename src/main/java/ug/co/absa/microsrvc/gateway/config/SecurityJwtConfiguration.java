package ug.co.absa.microsrvc.gateway.config;

import static ug.co.absa.microsrvc.gateway.security.SecurityUtils.AUTHORITIES_KEY;
import static ug.co.absa.microsrvc.gateway.security.SecurityUtils.JWT_ALGORITHM;
