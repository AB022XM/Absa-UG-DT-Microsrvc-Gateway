...
/**
 * Converter between {@link Row} to {@link Devices}, with proper type conversions.
 */
@Service
public class DevicesRowMapper implements BiFunction<Row, String, Devices> {

    private final ColumnConverter converter;

    public DevicesRowMapper(ColumnConverter converter) {
        this.converter = converter;
    }

    /**
     * Take a {@link Row} and a column prefix, and extract all the fields.
     * @return the {@link Devices} stored in the database.
     */
    @Override
    public Devices apply(Row row, String prefix) {
        ...
        entity.setDeviceName(converter.fromRow(row, prefix + "_device_name", String.class));
        entity.setDeviceType(converter.fromRow(row, prefix + "_device_type", String.class));
        entity.setDeviceDescription(converter.fromRow(row, prefix + "_device_description", String.class));
