...
import ug.co.absa.microsrvc.gateway.domain.Country;
import ug.co.absa.microsrvc.gateway.repository.CountryRepository;
import ug.co.absa.microsrvc.gateway.repository.search.CountrySearchRepository;
import ug.co.absa.microsrvc.gateway.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link ug.co.absa.microsrvc.gateway.domain.Country}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CountryResource {
    ...
    public Mono<List<Country>> searchCountries(@RequestParam String query) {
        ...
        return countrySearchRepository.search(query).collectList();
    }
}
