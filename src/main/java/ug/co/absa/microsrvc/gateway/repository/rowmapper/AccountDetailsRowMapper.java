...
/**
 * Converter between {@link Row} to {@link AccountDetails}, with proper type conversions.
 */
@Service
public class AccountDetailsRowMapper implements BiFunction<Row, String, AccountDetails> {

    private final ColumnConverter converter;

    public AccountDetailsRowMapper(ColumnConverter converter) {
        this.converter = converter;
    }

    /**
     * Take a {@link Row} and a column prefix, and extract all the fields.
     * @return the {@link AccountDetails} stored in the database.
     */
    @Override
    public AccountDetails apply(Row row, String prefix) {
