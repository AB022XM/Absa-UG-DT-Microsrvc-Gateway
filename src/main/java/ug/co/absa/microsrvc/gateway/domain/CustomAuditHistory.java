...
/**
 * A CustomAuditHistory.
 */
@Table("custom_audit_history")
@JsonIgnoreProperties(value = { "new" })
@org.springframework.data.elasticsearch.annotations.Document(indexName = "customaudithistory")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomAuditHistory implements Serializable, Persistable<UUID> {
    ...
    public CustomAuditHistory id(UUID id) {
        this.setId(id);
        return this;
    }
    ...
    public CustomAuditHistory recordId(String recordId) {
    ...
    public CustomAuditHistory actionId(ServiceLevel actionId) {
    ...
    public CustomAuditHistory timestamp(ZonedDateTime timestamp) {
    ...
    public CustomAuditHistory oldValue(String oldValue) {
    ...
    public CustomAuditHistory newValue(String newValue) {
    ...
    public CustomAuditHistory changeReason(String changeReason) {
    ...
    public CustomAuditHistory description(String description) {
    ...
    public CustomAuditHistory description1(String description1) {
    ...
    public CustomAuditHistory description2(String description2) {
    ...
    public CustomAuditHistory description3(String description3) {
    ...
    public CustomAuditHistory description4(String description4) {
    ...
    public CustomAuditHistory description5(String description5) {
    ...
    public CustomAuditHistory description6(String description6) {
    ...
    public CustomAuditHistory description7(String description7) {
    ...
    public CustomAuditHistory description8(String description8) {
    ...
    public CustomAuditHistory description9(String description9) {
    ...
    public CustomAuditHistory freeText1(String freeText1) {
    ...
    public CustomAuditHistory freeText2(String freeText2) {
    ...
    public CustomAuditHistory freeText3(String freeText3) {
    ...
    public CustomAuditHistory freeText4(String freeText4) {
    ...
    public CustomAuditHistory freeText5(String freeText5) {
    ...
    public CustomAuditHistory freeText6(String freeText6) {
    ...
    public CustomAuditHistory freeText7(String freeText7) {
    ...
    public CustomAuditHistory freeText8(String freeText8) {
    ...
    public CustomAuditHistory freeText9(String freeText9) {
    ...
    public CustomAuditHistory freeText10(String freeText10) {
    ...
    public CustomAuditHistory freeText11(String freeText11) {
    ...
    public CustomAuditHistory freeText12(String freeText12) {
    ...
    public CustomAuditHistory freeText13(String freeText13) {
    ...
    public CustomAuditHistory freeText14(String freeText14) {
    ...
    public CustomAuditHistory freeText15(String freeText15) {
    ...
    public CustomAuditHistory freeText16(String freeText16) {
    ...
    public CustomAuditHistory freeText17(String freeText17) {
    ...
    public CustomAuditHistory freeText18(String freeText18) {
    ...
    public CustomAuditHistory freeText19(String freeText19) {
    ...
    public CustomAuditHistory freeText20(String freeText20) {
    ...
    public CustomAuditHistory freeText21(String freeText21) {
    ...
    public CustomAuditHistory freeText22(String freeText22) {
    ...
    public CustomAuditHistory freeText23(String freeText23) {
    ...
    public CustomAuditHistory freeText24(String freeText24) {
    ...
    public CustomAuditHistory freeText25(String freeText25) {
    ...
    public CustomAuditHistory freeText26(String freeText26) {
    ...
    public CustomAuditHistory freeText27(String freeText27) {
    ...
    public CustomAuditHistory freeText28(String freeText28) {
    ...
    public CustomAuditHistory createdAt(ZonedDateTime createdAt) {
    ...
    public CustomAuditHistory createdBy(String createdBy) {
    ...
    public CustomAuditHistory updatedAt(ZonedDateTime updatedAt) {
    ...
    public CustomAuditHistory updatedBy(String updatedBy) {
    ...
    public CustomAuditHistory setIsPersisted() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustomAuditHistory)) {
            return false;
        }
        return id != null && id.equals(((CustomAuditHistory) o).id);
    }
