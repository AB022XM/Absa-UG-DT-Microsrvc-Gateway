...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.microsrvc.gateway.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.microsrvc.gateway.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.microsrvc.gateway.service.InvalidPasswordException
