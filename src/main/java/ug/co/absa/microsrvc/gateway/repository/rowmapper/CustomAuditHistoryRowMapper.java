...
/**
 * Converter between {@link Row} to {@link CustomAuditHistory}, with proper type conversions.
 */
@Service
public class CustomAuditHistoryRowMapper implements BiFunction<Row, String, CustomAuditHistory> {

    private final ColumnConverter converter;

    public CustomAuditHistoryRowMapper(ColumnConverter converter) {
        this.converter = converter;
    }

    /**
     * Take a {@link Row} and a column prefix, and extract all the fields.
     * @return the {@link CustomAuditHistory} stored in the database.
     */
    @Override
    public CustomAuditHistory apply(Row row, String prefix) {
        CustomAuditHistory entity = new CustomAuditHistory();
        ...
        entity.setChangeReason(converter.fromRow(row, prefix + "_change_reason", String.class));
