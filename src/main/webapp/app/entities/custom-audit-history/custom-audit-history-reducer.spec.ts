...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './custom-audit-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMAUDITHISTORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CUSTOMAUDITHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CUSTOMAUDITHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMAUDITHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMAUDITHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMAUDITHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMAUDITHISTORY actions', async () => {
      const expectedActions = [
        {
