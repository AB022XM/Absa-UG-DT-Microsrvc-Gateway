...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIQUIDATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LIQUIDATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LIQUIDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIQUIDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIQUIDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIQUIDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIQUIDATION actions', async () => {
      const expectedActions = [
        {
