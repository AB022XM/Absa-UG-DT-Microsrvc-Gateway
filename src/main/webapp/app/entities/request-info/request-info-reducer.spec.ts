...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTINFO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REQUESTINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REQUESTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUESTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUESTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUESTINFO actions', async () => {
      const expectedActions = [
        {
