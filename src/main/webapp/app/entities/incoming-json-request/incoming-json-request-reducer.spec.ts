...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './incoming-json-request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCOMINGJSONREQUEST_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INCOMINGJSONREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INCOMINGJSONREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCOMINGJSONREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCOMINGJSONREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCOMINGJSONREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCOMINGJSONREQUEST actions', async () => {
      const expectedActions = [
        {
