...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_APPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_APPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPS actions', async () => {
      const expectedActions = [
        {
