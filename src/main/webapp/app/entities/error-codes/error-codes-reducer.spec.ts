...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ERRORCODES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ERRORCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ERRORCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ERRORCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ERRORCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ERRORCODES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ERRORCODES actions', async () => {
      const expectedActions = [
        {
