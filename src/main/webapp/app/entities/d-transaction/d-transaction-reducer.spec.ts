...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DTRANSACTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DTRANSACTION actions', async () => {
      const expectedActions = [
        {
