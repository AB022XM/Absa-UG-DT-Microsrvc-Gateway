...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './amol-d-transactions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AMOLDTRANSACTIONS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_AMOLDTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_AMOLDTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AMOLDTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AMOLDTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AMOLDTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AMOLDTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
