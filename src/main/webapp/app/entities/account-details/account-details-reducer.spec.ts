...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTDETAILS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTDETAILS actions', async () => {
      const expectedActions = [
        {
