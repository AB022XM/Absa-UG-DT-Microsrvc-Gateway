...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './incoming-json-response.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCOMINGJSONRESPONSE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INCOMINGJSONRESPONSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INCOMINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCOMINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCOMINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCOMINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCOMINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
