...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLERACCOUNT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BILLERACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BILLERACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILLERACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILLERACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILLERACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILLERACCOUNT actions', async () => {
      const expectedActions = [
        {
