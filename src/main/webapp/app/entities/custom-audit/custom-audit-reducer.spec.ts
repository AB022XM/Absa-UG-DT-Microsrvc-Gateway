...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMAUDIT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CUSTOMAUDITS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CUSTOMAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMAUDIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMAUDIT actions', async () => {
      const expectedActions = [
        {
