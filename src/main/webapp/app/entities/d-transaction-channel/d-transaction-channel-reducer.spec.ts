...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './d-transaction-channel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DTRANSACTIONCHANNEL_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DTRANSACTIONCHANNELS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DTRANSACTIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DTRANSACTIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DTRANSACTIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DTRANSACTIONCHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DTRANSACTIONCHANNEL actions', async () => {
      const expectedActions = [
        {
