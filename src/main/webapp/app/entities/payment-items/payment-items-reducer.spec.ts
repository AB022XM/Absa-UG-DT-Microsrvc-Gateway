...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTITEMS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAYMENTITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAYMENTITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTITEMS actions', async () => {
      const expectedActions = [
        {
