...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BILLERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BILLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILLER actions', async () => {
      const expectedActions = [
        {
