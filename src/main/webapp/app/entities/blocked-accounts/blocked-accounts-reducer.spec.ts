...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOCKEDACCOUNTS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BLOCKEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BLOCKEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BLOCKEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BLOCKEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BLOCKEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BLOCKEDACCOUNTS actions', async () => {
      const expectedActions = [
        {
