...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERICCONFIGS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_GENERICCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_GENERICCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENERICCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENERICCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENERICCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENERICCONFIGS actions', async () => {
      const expectedActions = [
        {
