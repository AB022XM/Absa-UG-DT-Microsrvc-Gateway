...
export const BranchDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="absaUgdtMicrosrvcGatewayApp.branch.delete.question">
        <Translate contentKey="absaUgdtMicrosrvcGatewayApp.branch.delete.question" interpolate={{ id: branchEntity.id }}>
