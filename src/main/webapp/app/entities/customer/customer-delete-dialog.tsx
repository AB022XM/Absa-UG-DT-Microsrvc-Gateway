...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="absaUgdtMicrosrvcGatewayApp.customer.delete.question">
        <Translate contentKey="absaUgdtMicrosrvcGatewayApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
