...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './outgoing-json-response.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OUTGOINGJSONRESPONSE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_OUTGOINGJSONRESPONSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_OUTGOINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OUTGOINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OUTGOINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OUTGOINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OUTGOINGJSONRESPONSE actions', async () => {
      const expectedActions = [
        {
