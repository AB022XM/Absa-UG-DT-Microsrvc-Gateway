...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './d-transaction-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DTRANSACTIONHISTORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DTRANSACTIONHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DTRANSACTIONHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DTRANSACTIONHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DTRANSACTIONHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DTRANSACTIONHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DTRANSACTIONHISTORY actions', async () => {
      const expectedActions = [
        {
