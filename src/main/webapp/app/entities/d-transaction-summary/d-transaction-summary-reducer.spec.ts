...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './d-transaction-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DTRANSACTIONSUMMARY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DTRANSACTIONSUMMARIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DTRANSACTIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DTRANSACTIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DTRANSACTIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DTRANSACTIONSUMMARY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DTRANSACTIONSUMMARY actions', async () => {
      const expectedActions = [
        {
