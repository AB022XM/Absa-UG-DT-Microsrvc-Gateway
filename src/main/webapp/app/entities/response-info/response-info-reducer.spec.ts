...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPONSEINFO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_RESPONSEINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_RESPONSEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESPONSEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESPONSEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESPONSEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESPONSEINFO actions', async () => {
      const expectedActions = [
        {
