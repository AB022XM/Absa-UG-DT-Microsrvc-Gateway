...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="absaUgdtMicrosrvcGatewayApp.productCategory.delete.question">
        <Translate contentKey="absaUgdtMicrosrvcGatewayApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
