...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './d-transaction-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DTRANSACTIONDETAILS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DTRANSACTIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DTRANSACTIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DTRANSACTIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DTRANSACTIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DTRANSACTIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DTRANSACTIONDETAILS actions', async () => {
      const expectedActions = [
        {
