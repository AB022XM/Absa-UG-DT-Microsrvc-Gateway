...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTCONFIG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAYMENTCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAYMENTCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTCONFIG actions', async () => {
      const expectedActions = [
        {
