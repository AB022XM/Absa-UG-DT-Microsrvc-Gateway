...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEFAULTSETTINGS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEFAULTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEFAULTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEFAULTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEFAULTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEFAULTSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEFAULTSETTINGS actions', async () => {
      const expectedActions = [
        {
