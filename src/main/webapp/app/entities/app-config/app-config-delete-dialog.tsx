...
export const AppConfigDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="absaUgdtMicrosrvcGatewayApp.appConfig.delete.question">
        <Translate contentKey="absaUgdtMicrosrvcGatewayApp.appConfig.delete.question" interpolate={{ id: appConfigEntity.id }}>
