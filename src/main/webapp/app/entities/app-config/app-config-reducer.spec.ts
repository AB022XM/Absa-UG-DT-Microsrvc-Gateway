...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPCONFIG_LIST actions', async () => {
    ...
    it('dispatches SEARCH_APPCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_APPCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPCONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPCONFIG actions', async () => {
      const expectedActions = [
        {
