...
/**
 * Performance test for the Devices entity.
 */
class DevicesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Devices entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created devices")
                .get("${new_devices_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created devices")
            .delete("${new_devices_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
